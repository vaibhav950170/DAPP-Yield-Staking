...
class App extends Component{
    ...
    async loadWeb3() {
        if (window.ethereum){
            ...
            await window.ethereum.enable()
                ...
                window.alert('No ethereuem browser is detected.')
            }
        }
    ...
    async loadBlockchainData() {
        ...
        if(rwdData){
            ...
            window.alert('Error! Reward Contract not deployed to detect netwrok')
        }
        //Load Decentral Bank Contact
        ...
        if(decentralBankData){
            ...
            window.alert('Error! decentralBank Contract not deployed to detect netwrok')
        }
